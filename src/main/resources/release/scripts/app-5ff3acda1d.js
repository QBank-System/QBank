...
!function () {
    ...
    angular.module("BlurAdmin.pages", ["ui.router", "BlurAdmin.pages.dashboard", "BlurAdmin.pages.ui", "BlurAdmin.pages.components", "BlurAdmin.pages.form", "BlurAdmin.pages.tables", "BlurAdmin.pages.charts", "BlurAdmin.pages.maps", "BlurAdmin.pages.profile"]).config(e), e.$inject = ["$urlRouterProvider"]
}(), function () {
    "use strict";
    ...
    function e(e) {
        e.state("charts", {
            ...
            title: "Charts",
            sidebarMeta: {icon: "ion-stats-bars", order: 150}
        })
    }

    angular.module("BlurAdmin.pages.charts", ["BlurAdmin.pages.charts.amCharts", "BlurAdmin.pages.charts.chartJs", "BlurAdmin.pages.charts.chartist", "BlurAdmin.pages.charts.morris"]).config(e), e.$inject = ["$stateProvider"]
}(), function () {
    "use strict";
    function e(e) {
        e.state("components", {
            ...
            "abstract": !0,
            title: "Components",
            sidebarMeta: {icon: "ion-gear-a", order: 100}
        })
    }

    angular.module("BlurAdmin.pages.components", ["BlurAdmin.pages.components.mail", "BlurAdmin.pages.components.timeline", "BlurAdmin.pages.components.tree"]).config(e), e.$inject = ["$stateProvider"]
}(), function () {
    "use strict";
    function e(e) {
        e.state("dashboard", {
    ...
    angular.module("BlurAdmin.pages.dashboard", []).config(e), e.$inject = ["$stateProvider"]
}(), function () {
    "use strict";
    function e(e) {
        e.state("form", {
            ...
            "abstract": !0,
            title: "Form Elements",
            sidebarMeta: {icon: "ion-compose", order: 250}
        }).state("form.inputs", {
            url: "/inputs",
            ...
            controllerAs: "vm",
            title: "Form Wizard",
            sidebarMeta: {order: 200}
        })
    }

    angular.module("BlurAdmin.pages.form", []).config(e), e.$inject = ["$stateProvider"]
}(), function () {
    "use strict";
    function e(e) {
        e.state("maps", {
            ...
            "abstract": !0,
            title: "Maps",
            sidebarMeta: {icon: "ion-ios-location-outline", order: 500}
        }).state("maps.gmap", {
            url: "/gmap",
            ...
            title: "Line Maps",
            sidebarMeta: {order: 300}
        })
    }

    angular.module("BlurAdmin.pages.maps", []).config(e), e.$inject = ["$stateProvider"]
}(), function () {
    "use strict";
    function e(e, a) {
        e.state("tables", {
            ...
            title: "Tables",
            sidebarMeta: {icon: "ion-grid", order: 300}
        }).state("tables.basic", {
            url: "/basic",
    ...
    angular.module("BlurAdmin.pages.tables", []).config(e), e.$inject = ["$stateProvider", "$urlRouterProvider"]
}(), function () {
    "use strict";
    function e(e) {
        e.state("profile", {
    ...
    angular.module("BlurAdmin.pages.profile", []).config(e), e.$inject = ["$stateProvider"]
}(), function () {
    "use strict";
    function e(e) {
        e.state("ui", {
    ...
    angular.module("BlurAdmin.pages.charts.amCharts", []).config(e), e.$inject = ["$stateProvider"]
}(), function () {
    "use strict";
    function e(e) {
    ...
    angular.module("BlurAdmin.pages.charts.chartJs", []).config(e), e.$inject = ["$stateProvider"]
}(), function () {
    "use strict";
    function e(e) {
    ...
    angular.module("BlurAdmin.pages.charts.chartist", []).config(e), e.$inject = ["$stateProvider"]
}(), function () {
    "use strict";
    function e(e) {
    ...
    angular.module("BlurAdmin.pages.charts.morris", []).config(e).config(function () {
        Morris.Donut.prototype.defaults.backgroundColor = "transparent", Morris.Donut.prototype.defaults.labelColor = "rgba(255,255,255,0.8)", Morris.Grid.prototype.gridDefaults.gridLineColor = "rgba(255,255,255,0.8)", Morris.Grid.prototype.gridDefaults.gridTextColor = "rgba(255,255,255,0.8)"
    ...
    angular.module("BlurAdmin.pages.components.mail", []).config(e), e.$inject = ["$stateProvider", "$urlRouterProvider"]
}(), function () {
    "use strict";
    function e(e) {
    ...
    angular.module("BlurAdmin.pages.components.timeline", []).config(e), e.$inject = ["$stateProvider"]
}(), function () {
    "use strict";
    function e(e) {
    ...
    angular.module("BlurAdmin.pages.components.tree", []).config(e).config(function () {
    ...
    angular.module("BlurAdmin.pages.ui.buttons", []).config(e), e.$inject = ["$stateProvider"]
}(), function () {
    "use strict";
    function e(e) {
        e.state("ui.alerts", {
            ...
            title: "Alerts",
            sidebarMeta: {order: 500}
        })
    }

    angular.module("BlurAdmin.pages.ui.alerts", []).config(e), e.$inject = ["$stateProvider"]
}(), function () {
    "use strict";
    function e(e) {
        e.state("ui.grid", {
            ...
            title: "Grid",
            sidebarMeta: {order: 400}
        })
    }

    angular.module("BlurAdmin.pages.ui.grid", []).config(e), e.$inject = ["$stateProvider"]
}(), function () {
    "use strict";
    function e(e) {
        e.state("ui.icons", {
    ...
    angular.module("BlurAdmin.pages.ui.icons", []).config(e), e.$inject = ["$stateProvider"]
}(), function () {
    "use strict";
    function e(e) {
        e.state("ui.modals", {
    ...
    angular.module("BlurAdmin.pages.ui.modals", []).config(e), e.$inject = ["$stateProvider"]
}(), function () {
    "use strict";
    function e(e) {
        e.state("ui.notifications", {
            ...
            title: "Notifications",
            sidebarMeta: {order: 700}
        })
    }

    angular.module("BlurAdmin.pages.ui.notifications", []).config(e), e.$inject = ["$stateProvider"]
}(), function () {
    "use strict";
    function e(e) {
        e.state("ui.panels", {
            ...
            controller: "NotificationsPageCtrl",
            title: "Panels",
            sidebarMeta: {order: 1100}
        })
    }

    angular.module("BlurAdmin.pages.ui.panels", []).config(e), e.$inject = ["$stateProvider"]
}(), function () {
    "use strict";
    function e(e) {
        e.state("ui.progressBars", {
            ...
            title: "Progress Bars",
            sidebarMeta: {order: 600}
        })
    }

    angular.module("BlurAdmin.pages.ui.progressBars", []).config(e), e.$inject = ["$stateProvider"]
}(), function () {
    "use strict";
    function e(e) {
        e.state("ui.slider", {
            ...
            title: "Sliders",
            sidebarMeta: {order: 1e3}
        })
    }

    angular.module("BlurAdmin.pages.ui.slider", []).config(e), e.$inject = ["$stateProvider"]
}(), function () {
    "use strict";
    function e(e) {
        e.state("ui.tabs", {
    ...
    angular.module("BlurAdmin.pages.ui.tabs", []).config(e), e.$inject = ["$stateProvider"]
}(), function () {
    "use strict";
    function e(e) {
    ...
    angular.module("BlurAdmin.pages.ui.typography", []).config(e), e.$inject = ["$stateProvider"]
}(), angular.module("BlurAdmin", ["ngAnimate", "ui.bootstrap", "ui.sortable", "ui.router", "ngTouch", "toastr", "smart-table", "xeditable", "ui.slimscroll", "ngJsTree", "angular-progress-button-styles", "BlurAdmin.theme", "BlurAdmin.pages", "BlurAdmin.tplSkin"]), function () {
    "use strict";
    function e(e) {
        AmCharts.themes.blur = {
            themeName: "blur",
            AmChart: {color: e.defaultText, backgroundColor: "#FFFFFF"},
            AmCoordinateChart: {colors: [e.primary, e.danger, e.warning, e.success, e.info, e["default"], e.primaryDark, e.warningLight, e.successDark, e.successLight, e.successBg]},
            AmStockChart: {colors: [e.primary, e.danger, e.warning, e.success, e.info, e["default"], e.primaryDark, e.warningLight, e.successDark, e.successLight, e.successBg]},
            AmSlicedChart: {
                colors: [e.primary, e.danger, e.warning, e.success, e.info, e["default"], e.primaryDark, e.warningLight, e.successDark, e.successLight, e.successBg],
            ...
            AxisBase: {axisColor: "#FFFFFF", axisAlpha: .3, gridAlpha: .1, gridColor: "#FFFFFF"},
            ChartScrollbar: {
            ...
            ChartCursor: {cursorColor: e.primary, color: "#FFFFFF", cursorAlpha: .5},
            ...
            TrendLine: {lineColor: e.danger, lineAlpha: .8},
            AreasSettings: {
                alpha: .8,
                color: e.info,
                colorSolid: e.primaryDark,
                unlistedAreasAlpha: .4,
                unlistedAreasColor: "#FFFFFF",
                outlineColor: "#FFFFFF",
                outlineAlpha: .5,
                outlineThickness: .5,
                rollOverColor: e.primary,
            ...
            LinesSettings: {color: "#FFFFFF", alpha: .8},
            ImagesSettings: {alpha: .8, labelColor: "#FFFFFF", color: "#FFFFFF", labelRollOverColor: e.primaryDark},
            ZoomControl: {
                buttonFillAlpha: .8,
                buttonIconColor: e["default"],
                buttonRollOverColor: e.danger,
                buttonFillColor: e.primaryDark,
                buttonBorderColor: e.primaryDark,
                buttonBorderAlpha: 0,
    ...
    angular.module("BlurAdmin.theme").config(e), e.$inject = ["layoutColors"]
}(), function () {
    "use strict";
    function e(e, a) {
        e.setOptions({
            colours: [a.primary, a.danger, a.warning, a.success, a.info, a["default"], a.primaryDark, a.successDark, a.warningLight, a.successLight, a.successBg],
            responsive: !0,
            scaleFontColor: "rgba(255,255,255,.7)",
            scaleLineColor: "rgba(255,255,255,.7)",
            pointLabelFontColor: "rgba(255,255,255,.7)"
        }), e.setOptions("Line", {datasetFill: !1})
    }

    angular.module("BlurAdmin.theme").config(e), e.$inject = ["ChartJsProvider", "layoutColors"]
}(), function () {
    "use strict";
    function e(e, a) {
        return t("#000000", e, a)
    ...
    function t(e, a, t) {
        ...
        for (var l = "#", o = 1; 7 > o; o += 2) {
            var n = s(e.substr(o, 2)), r = s(a.substr(o, 2)), d = i(Math.floor(r + (n - r) * (t / 100)));
            l += ("0" + d).slice(-2)
        }
        return l
    }
    ...
    var i = "assets/img/", s = {
        ...
        warning: "#dfb81c",
        danger: "#e85656"
    }, l = {blueStone: "#005562", surfieGreen: "#0e8174", silverTree: "#6eba8c", gossip: "#b9f2a1", white: "#ffffff"};
    angular.module("BlurAdmin.theme").constant("layoutColors", {
        primary: s.primary,
        info: s.info,
        success: s.success,
        warning: s.warning,
        danger: s.danger,
        primaryLight: a(s.primary, 30),
        infoLight: a(s.info, 30),
        successLight: a(s.success, 30),
        warningLight: a(s.warning, 30),
        dangerLight: a(s.danger, 30),
        primaryDark: e(s.primary, 15),
        infoDark: e(s.info, 15),
        successDark: e(s.success, 15),
        warningDark: e(s.warning, 15),
        dangerDark: e(s.danger, 15),
        primaryBg: a(s.primary, 20),
        infoBg: a(s.info, 20),
        successBg: a(s.success, 20),
        warningBg: a(s.warning, 20),
        dangerBg: a(s.danger, 20),
        "default": "#ffffff",
        defaultText: "#ffffff",
        bgColorPalette: {
            blueStone: l.blueStone,
            surfieGreen: l.surfieGreen,
            silverTree: l.silverTree,
            gossip: l.gossip,
            white: l.white,
            blueStoneDark: e(l.blueStone, 15),
            surfieGreenDark: e(l.surfieGreen, 15),
            silverTreeDark: e(l.silverTree, 15),
            gossipDark: e(l.gossip, 15),
            whiteDark: e(l.white, 5)
        }
    ...
    "use strict";
    function e(e, a, t, i, s, l) {
        a.$isMobile = /android|webos|iphone|ipad|ipod|blackberry|windows phone/.test(navigator.userAgent.toLowerCase());
        var o = [s.loadAmCharts(), e(3e3)];
        a.$isMobile ? o.unshift(s.loadImg(i.images.root + "blur-bg-mobile.jpg")) : (o.unshift(s.loadImg(i.images.root + "blur-bg.jpg")), o.unshift(s.loadImg(i.images.root + "blur-bg-blurred.jpg"))), l.all(o).then(function () {
            a.$pageFinishedLoading = !0
        }), e(function () {
            a.$pageFinishedLoading || (a.$pageFinishedLoading = !0)
        }, 7e3), a.$isMenuCollapsed = window.innerWidth <= t.resWidthCollapseSidebar
    }

    angular.module("BlurAdmin.theme").run(e), e.$inject = ["$timeout", "$rootScope", "layoutSizes", "layoutPaths", "preloader", "$q"]
}(), function () {
    "use strict";
    function e(e) {
        angular.extend(e, {
    ...
    angular.module("BlurAdmin.theme").config(e), e.$inject = ["toastrConfig"]
}(), function () {
    "use strict";
    var e = "badmin", a = [{
        name: "Transparent (beta)",
        bodyClass: e + "-transparent",
        ...
        name: "Material",
        bodyClass: e + "-material",
        thumbnailUrl: "assets/img/app/skin-thumbnails/05_material.jpg",
        panelType: "panel-white",
        chartColorProfile: "whitePanel"
    }, {
        name: "Transblue (beta)",
        bodyClass: e + "-transblue",
        panelType: "panel-blur",
        thumbnailUrl: "assets/img/app/skin-thumbnails/06_transblue.jpg",
        chartColorProfile: "transparent"
    }], t = {
        whitePanel: {fontColors: void 0, axisColors: "#7b7b7b"},
        transparent: {fontColors: "#FFFFFF", axisColors: "#FFFFFF"}
    };
    angular.module("BlurAdmin.tplSkin").constant("tplSkinClassPrefix", e).constant("tplSkinEnum", a).constant("tplSkinChartColors", t)
}(), function () {
    "use strict";
    function e(e) {
        this.watchAxisChartStyleChanges = function (a, t) {
            function i() {
                var a = e.getChartColorProfile();
                t.color = a.fontColors, t.categoryAxis.color = a.fontColors, t.categoryAxis.axisColor = a.axisColors, t.valueAxes[0].color = a.fontColors, t.valueAxes[0].axisColor = a.axisColors, t.validateNow()
            }

            i(), a.$on("tplSkinChanged", i)
        }, this.watchChartColorChanges = function (a, t) {
            function i() {
                var a = e.getChartColorProfile();
                t.color = a.fontColors, t.validateNow()
            }

            i(), a.$on("tplSkinChanged", i)
        }, this.watchDonutChanges = function (a, t) {
            function i() {
                var a = e.getChartColorProfile();
                t.color = a.fontColors, t.legend.color = a.fontColors, t.labelTickColor = a.axisColors, t.validateNow()
            }

            i(), a.$on("tplSkinChanged", i)
        }, this.watchFunnelChanges = function (a, t) {
            function i() {
                var a = e.getChartColorProfile();
                t.color = a.fontColors, t.labelTickColor = a.axisColors, t.validateNow()
            }
    ...
    angular.module("BlurAdmin.tplSkin").service("tplSkinChartWatcherHelper", e), e.$inject = ["tplSkinManager"]
}(), function () {
    "use strict";
    function e(e, a, t, i, s) {
        function l() {
            var e = a[0].body, i = angular.element(e);
            e.className.split(/\s+/).forEach(function (e) {
                0 === e.indexOf(t) && i.removeClass(e)
            })
        }

        function o(e) {
            angular.element(a[0].body).addClass(e.bodyClass)
        }

        var n = s[0];
        this.setActiveSkin = function (a) {
            n = a, n && (l(), o(n), e.$broadcast("tplSkinChanged"))
        }, this.getActiveSkin = function () {
            return n
        }, this.getChartColorProfile = function () {
            return i[n.chartColorProfile]
        }, this.setActiveSkin(n)
    }

    angular.module("BlurAdmin.tplSkin").service("tplSkinManager", e), e.$inject = ["$rootScope", "$document", "tplSkinClassPrefix", "tplSkinChartColors", "tplSkinEnum"]
}(), function () {
    "use strict";
    function e(e, a) {
        return {
            templateUrl: "app/tplSkin/tplSkinPanel.html", link: function (t) {
                t.skins = e, t.setActiveSkin = function (e) {
                    a.setActiveSkin(e)
                }
            }
        }
    ...
    angular.module("BlurAdmin.tplSkin").directive("tplSkinPanel", e), e.$inject = ["tplSkinEnum", "tplSkinManager"]
}(), function () {
    "use strict";
    function e(e, a, t, i) {
        e.smartTablePageSize = 10, e.smartTableData = [{
            ...
            percent: "5%",
            isPercentUp: !1
        }], e.users = [{id: 1, name: "Esther Vang", status: 4, group: 3}, {
            id: 2,
            name: "Leah Freeman",
            status: 3,
            group: 1
        }, {id: 3, name: "Mathews Simpson", status: 3, group: 2}, {id: 4, name: "Buckley Hopkins", group: 4}, {
            id: 5,
            ...
            status: 1,
            group: 2
        }, {id: 10, name: "Mathews Schwartz", status: 1, group: 3}], e.statuses = [{value: 1, text: "Good"}, {
            value: 2,
            text: "Awesome"
        }, {value: 3, text: "Excellent"}], e.groups = [{id: 1, text: "user"}, {id: 2, text: "customer"}, {
            id: 3,
            text: "vip"
        }, {id: 4, text: "admin"}], e.showGroup = function (t) {
            if (t.group && e.groups.length) {
                var i = a("filter")(e.groups, {id: t.group});
                return i.length ? i[0].text : "Not set"
            }
            return "Not set"
        }, e.showStatus = function (t) {
            var i = [];
            return t.status && (i = a("filter")(e.statuses, {value: t.status})), i.length ? i[0].text : "Not set"
        }, e.removeUser = function (a) {
            e.users.splice(a, 1)
        }, e.addUser = function () {
            e.inserted = {id: e.users.length + 1, name: "", status: null, group: null}, e.users.push(e.inserted)
    ...
    angular.module("BlurAdmin.pages.tables").controller("TablesPageCtrl", e), e.$inject = ["$scope", "$filter", "editableOptions", "editableThemes"]
}(), function () {
    "use strict";
    function e(e, a) {
    ...
    angular.module("BlurAdmin.pages.profile").controller("ProfileModalCtrl", e), e.$inject = ["$scope", "$uibModalInstance"]
}(), function () {
    "use strict";
    function e(e, a, t, i) {
    ...
    angular.module("BlurAdmin.pages.profile").controller("ProfilePageCtrl", e), e.$inject = ["$scope", "fileReader", "$filter", "$uibModal"]
}(), function () {
    "use strict";
    function e(e) {
        return {
            link: function (a, t) {
                e(function () {
                    ...
                    var i = t.attr("new-value"), s = parseInt(t.html());
                    if (i > s)for (var l = s; i >= l; l++)a(l); else for (var o = s; o >= i; o--)a(o);
                    e(function () {
    ...
    angular.module("BlurAdmin.theme").directive("animatedChange", e), e.$inject = ["$timeout"]
}(), function () {
    "use strict";
    function e() {
        return {
            restrict: "A", link: function (e, a) {
                a.bind("keydown", function (e) {
                    ...
                    t = 16 > t ? 16 : t, $(a).height(t)
                }), setTimeout(function () {
                    var e = a;
                    $(e).height(0);
                    var t = $(e)[0].scrollHeight;
                    t = 16 > t ? 16 : t, $(e).height(t)
                }, 0)
            }
        }
    }
    ...
    angular.module("BlurAdmin.theme").directive("autoFocus", e), e.$inject = ["$timeout", "$parse"]
}(), function () {
    "use strict";
    function e() {
        return {
            restrict: "AE", templateUrl: function (e, a) {
        ...
        return {
            ...
            link: function (a, t) {
                t.ionRangeSlider({
                    ...
                    e(function () {
                        t.data("ionRangeSlider").update({min: a})
                    })
                }, !0), a.$watch("max", function (a) {
                    e(function () {
                        t.data("ionRangeSlider").update({max: a})
                    })
                }), a.$watch("from", function (a) {
                    e(function () {
                        t.data("ionRangeSlider").update({from: a})
                    })
                }), a.$watch("to", function (a) {
                    e(function () {
                        t.data("ionRangeSlider").update({to: a})
                    })
                }), a.$watch("disable", function (a) {
                    e(function () {
                        t.data("ionRangeSlider").update({disable: a})
                    })
                })
            }
        }
    ...
    angular.module("BlurAdmin.theme").directive("ionSlider", e), e.$inject = ["$timeout"]
}(), function () {
    "use strict";
    function e() {
        return {
    ...
    function e() {
        return {
            scope: {trackWidth: "=", minWidth: "="}, link: function (e, a) {
    ...
    angular.module("BlurAdmin.theme").directive("zoomIn", e), e.$inject = ["$timeout", "$rootScope"]
}(), function () {
    "use strict";
    function e(e) {
        var a = function (e, a, t) {
            ...
            return function (e) {
                a.$broadcast("fileProgress", {total: e.total, loaded: e.loaded})
            }
        }, s = function (e, s) {
            var l = new FileReader;
            return l.onload = a(l, e, s), l.onerror = t(l, e, s), l.onprogress = i(l, s), l
        }, l = function (a, t) {
            var i = e.defer(), l = s(i, t);
            return l.readAsDataURL(a), i.promise
        };
        return {readAsDataUrl: l}
    }

    angular.module("BlurAdmin.theme").service("fileReader", e), e.$inject = ["$q"]
}(), function () {
    "use strict";
    function e(e) {
        return {
            loadImg: function (a) {
                var t = e.defer(), i = new Image;
    ...
    angular.module("BlurAdmin.theme").service("preloader", e), e.$inject = ["$q"]
}(), function () {
    "use strict";
    function e(e) {
        return {
    ...
    angular.module("BlurAdmin.theme").service("stopableInterval", e), e.$inject = ["$window"]
}(), function () {
    "use strict";
    function e(e) {
        function a(e) {
        ...
        e.labels = ["Sleeping", "Designing", "Coding", "Cycling"], e.data = [20, 40, 5, 35], e.options = {segmentShowStroke: !1}, e.polarOptions = {
    ...
    angular.module("BlurAdmin.pages.charts.chartJs").controller("chartJs1DCtrl", e), e.$inject = ["$scope"]
}(), function () {
    "use strict";
    function e(e) {
        function a(e) {
    ...
    angular.module("BlurAdmin.pages.charts.chartJs").controller("chartJs2DCtrl", e), e.$inject = ["$scope"]
}(), function () {
    "use strict";
    function e(e, a, t) {
    ...
    angular.module("BlurAdmin.pages.charts.chartJs").controller("chartJsWaveCtrl", e), e.$inject = ["$scope", "$interval", "stopableInterval"]
}(), function () {
    "use strict";
    function e(e, a) {
        function t(e, a) {
        ...
        }, e.simplePieData = {series: [5, 3, 4]}, e.simplePieOptions = {
            fullWidth: !0,
            height: "300px",
            weight: "300px",
            labelInterpolationFnc: function (e) {
        ...
        }, e.donutResponsive = t(5, 40), e.pieResponsive = t(20, 80), a(function () {
    ...
    angular.module("BlurAdmin.pages.charts.chartist").controller("chartistCtrl", e), e.$inject = ["$scope", "$timeout"]
}(), function () {
    "use strict";
    function e(e, a, t) {
        e.colors = [t.primary, t.warning, t.danger, t.info, t.success, t["default"], t.primaryDark], e.lineData = [{
            y: "2006",
            a: 100,
            b: 90
        }, {y: "2007", a: 75, b: 65}, {y: "2008", a: 50, b: 40}, {y: "2009", a: 75, b: 65}, {
            y: "2010",
            a: 50,
            b: 40
        }, {y: "2011", a: 75, b: 65}, {y: "2012", a: 100, b: 90}], e.areaData = [{y: "2006", a: 100, b: 90}, {
            y: "2007",
            a: 75,
            b: 65
        }, {y: "2008", a: 50, b: 40}, {y: "2009", a: 75, b: 65}, {y: "2010", a: 50, b: 40}, {
            y: "2011",
            a: 75,
            b: 65
        }, {y: "2012", a: 100, b: 90}], e.barData = [{y: "2006", a: 100, b: 90}, {y: "2007", a: 75, b: 65}, {
            y: "2008",
            a: 50,
            b: 40
            ...
            a: 100,
            b: 90
        }], e.donutData = [{label: "Download Sales", value: 12}, {
            label: "In-Store Sales",
            value: 30
        }, {label: "Mail-Order Sales", value: 20}], angular.element(a).bind("resize", function () {
        })
    }

    angular.module("BlurAdmin.pages.charts.morris").controller("morrisCtrl", e), e.$inject = ["$scope", "$window", "layoutColors"]
}(), function () {
    "use strict";
    function e(e, a) {
        var t = this;
        t.navigationCollapsed = !0, t.showCompose = function (a, t, i) {
            e.open({subject: a, to: t, text: i})
        }, t.tabs = a.getTabs()
    }

    angular.module("BlurAdmin.pages.components.mail").controller("MailTabCtrl", e), e.$inject = ["composeModal", "mailMessages"]
}(), function () {
    "use strict";
    function e(e) {
        var a = [{
        ...
        }).reverse(), t = [{label: "inbox", name: "Inbox", newMails: 7}, {
            label: "sent",
            name: "Sent Mail"
        }, {label: "important", name: "Important"}, {label: "draft", name: "Draft", newMails: 2}, {
            label: "spam",
            name: "Spam"
    ...
    angular.module("BlurAdmin.pages.components.mail").service("mailMessages", e), e.$inject = ["$sce"]
}(), function () {
    "use strict";
    function e() {
        function e(e, a) {
    ...
    angular.module("BlurAdmin.pages.dashboard").controller("BlurFeedCtrl", e), e.$inject = ["$scope"]
}(), function () {
    "use strict";
    function e() {
        return {restrict: "E", controller: "BlurFeedCtrl", templateUrl: "app/pages/dashboard/blurFeed/blurFeed.html"}
    }
    ...
    function e(e, a) {
        function t() {
            return [{id: "n1", parent: "#", type: "folder", text: "Node 1", state: {opened: !0}}, {
                id: "n2",
                parent: "#",
                type: "folder",
                text: "Node 2",
                state: {opened: !0}
            }, {id: "n3", parent: "#", type: "folder", text: "Node 3", state: {opened: !0}}, {
                id: "n5",
                parent: "n1",
                text: "Node 1.1",
                state: {opened: !0}
            }, {id: "n6", parent: "n1", text: "Node 1.2", state: {opened: !0}}, {
                id: "n7",
                parent: "n1",
                text: "Node 1.3",
                state: {opened: !0}
            }, {id: "n8", parent: "n1", text: "Node 1.4", state: {opened: !0}}, {
                id: "n9",
                parent: "n2",
                text: "Node 2.1",
                state: {opened: !0}
                ...
                icon: "ion-help-buoy",
                state: {opened: !0}
            }, {id: "n12", parent: "n3", text: "Node 3.1", state: {opened: !0}}, {
                id: "n13",
                parent: "n3",
                type: "folder",
                text: "Node 3.2",
                state: {opened: !0}
            }, {id: "n14", parent: "n13", text: "Node 3.2.1", state: {opened: !0}}, {
                id: "n15",
                parent: "n13",
                text: "Node 3.2.2",
                state: {opened: !0}
            }, {id: "n16", parent: "n3", text: "Node 3.3", state: {opened: !0}}, {
                id: "n17",
                parent: "n3",
                text: "Node 3.4",
                state: {opened: !0}
            }, {id: "n18", parent: "n3", text: "Node 3.5", state: {opened: !0}}, {
                id: "n19",
                parent: "n3",
                text: "Node 3.6",
                state: {opened: !0}
        ...
        e.ignoreChanges = !1, e.newNode = {}, e.basicConfig = {
            core: {multiple: !1, check_callback: !0, worker: !0},
            types: {folder: {icon: "ion-ios-folder"}, "default": {icon: "ion-document-text"}},
            plugins: ["types"],
            version: 1
        }, e.dragConfig = {
            ...
            text: "Node 1",
            state: {opened: !0}
        }, {id: "nd2", parent: "#", type: "folder", text: "Node 2", state: {opened: !0}}, {
            id: "nd3",
            parent: "#",
            type: "folder",
            text: "Node 3",
            state: {opened: !0}
        }, {id: "nd4", parent: "#", type: "folder", text: "Node 4", state: {opened: !0}}, {
            id: "nd5",
            parent: "nd1",
            text: "Node 1.1",
            state: {opened: !0}
        }, {id: "nd6", parent: "nd1", text: "Node 1.2", state: {opened: !0}}, {
            id: "nd7",
            parent: "nd1",
            text: "Node 1.3",
            state: {opened: !0}
        }, {id: "nd8", parent: "nd2", text: "Node 2.1", state: {opened: !0}}, {
            id: "nd9",
            parent: "nd2",
            text: "Node 2.2",
            state: {opened: !0}
        }, {id: "nd10", parent: "nd2", text: "Node 2.3", state: {opened: !0}}, {
            id: "nd11",
            parent: "nd3",
            text: "Node 3.1",
            state: {opened: !0}
        }, {id: "nd12", parent: "nd3", text: "Node 3.2", state: {opened: !0}}, {
            id: "nd13",
            parent: "nd3",
            text: "Node 3.3",
            state: {opened: !0}
        }, {id: "nd14", parent: "nd4", text: "Node 4.1", state: {opened: !0}}, {
            id: "nd15",
            parent: "nd4",
            text: "Node 4.2",
            state: {opened: !0}
        }, {id: "nd16", parent: "nd4", text: "Node 4.3", state: {opened: !0}}]
    }

    angular.module("BlurAdmin.pages.components.tree").controller("treeCtrl", e), e.$inject = ["$scope", "$timeout"]
}(), function () {
    "use strict";
    function e() {
    }
    ...
    "use strict";
    function e(e) {
        var a = e.bgColorPalette, t = $("#calendar").fullCalendar({
            header: {
            ...
            editable: !0,
            eventLimit: !0,
            events: [{title: "All Day Event", start: "2016-03-01", color: a.silverTree}, {
                title: "Long Event",
                start: "2016-03-07",
                end: "2016-03-10",
                color: a.blueStone
            }, {title: "Dinner", start: "2016-03-14T20:00:00", color: a.surfieGreen}, {
    ...
    angular.module("BlurAdmin.pages.dashboard").controller("DashboardCalendarCtrl", e), e.$inject = ["layoutColors"]
}(), function () {
    "use strict";
    function e() {
        return {
    ...
    function e(e, a) {
        AmCharts.makeChart("amChartMap", {
            type: "map",
            theme: "blur",
            zoomControl: {zoomControlEnabled: !1, panControlEnabled: !1},
            dataProvider: {
                map: "worldLow",
                zoomLevel: 3.5,
                zoomLongitude: 10,
                ...
                areas: [{
                    ...
                    customData: "1 244",
                    groupId: "1"
                }, {title: "Ireland", id: "IE", color: e.primary, customData: "1 342", groupId: "1"}, {
                    title: "Denmark",
                    id: "DK",
                    color: e.primary,
                    customData: "1 973",
                    groupId: "1"
                }, {title: "Finland", id: "FI", color: e.primary, customData: "1 573", groupId: "1"}, {
                    title: "Sweden",
                    id: "SE",
                    color: e.primary,
                    customData: "1 084",
                    ...
                    customData: "1 452",
                    groupId: "1"
                }, {title: "Italy", id: "IT", color: e.primary, customData: "1 321", groupId: "1"}, {
                    title: "France",
                    id: "FR",
                    color: e.primary,
                    customData: "1 112",
                    groupId: "1"
                }, {title: "Spain", id: "ES", color: e.primary, customData: "1 865", groupId: "1"}, {
                    title: "Greece",
                    id: "GR",
                    color: e.primary,
                    customData: "1 453",
                    groupId: "1"
                }, {title: "Germany", id: "DE", color: e.primary, customData: "1 957", groupId: "1"}, {
                    title: "Belgium",
                    id: "BE",
                    color: e.primary,
                    customData: "1 011",
                    ...
                    customData: "854",
                    groupId: "2"
                }, {title: "Cyprus", id: "CY", color: e.successLight, customData: "754", groupId: "2"}, {
                    title: "Malta",
                    id: "MT",
                    color: e.successLight,
                    customData: "867",
                    ...
                    customData: "759",
                    groupId: "2"
                }, {title: "Romania", id: "RO", color: e.success, customData: "302", groupId: "3"}, {
                    title: "Bulgaria",
                    id: "BG",
                    color: e.success,
                    customData: "102",
                    groupId: "3"
                }, {title: "Slovenia", id: "SI", color: e.danger, customData: "23", groupId: "4"}, {
                    title: "Croatia",
                    id: "HR",
                    color: e.danger,
                    customData: "96",
            ...
            legend: {
                ...
                left: 0,
                horizontalGap: 10,
                data: [{title: "over 1 000 users", color: e.primary}, {
                    title: "500 - 1 000 users",
                    color: e.successLight
                }, {title: "100 - 500 users", color: e.success}, {title: "0 - 100 users", color: e.danger}]
            },
            "export": {enabled: !0},
    ...
    angular.module("BlurAdmin.pages.dashboard").controller("DashboardMapCtrl", e), e.$inject = ["layoutColors", "layoutPaths"]
}(), function () {
    "use strict";
    function e() {
        return {
    ...
    function e(e, a, t, i, s) {
        function l() {
            r.zoomToDates(new Date(2013, 3), new Date(2014, 0))
        }

        var o = [{date: new Date(2012, 11), value: 0, value0: 0}, {
            date: new Date(2013, 0),
            value: 15e3,
            value0: 19e3
        }, {date: new Date(2013, 1), value: 3e4, value0: 2e4}, {
            date: new Date(2013, 2),
            value: 25e3,
            value0: 22e3
        }, {date: new Date(2013, 3), value: 21e3, value0: 25e3}, {
            date: new Date(2013, 4),
            value: 24e3,
            value0: 29e3
        }, {date: new Date(2013, 5), value: 31e3, value0: 26e3}, {
            date: new Date(2013, 6),
            value: 4e4,
            value0: 25e3
        }, {date: new Date(2013, 7), value: 37e3, value0: 2e4}, {
            date: new Date(2013, 8),
            value: 18e3,
            value0: 22e3
        }, {date: new Date(2013, 9), value: 5e3, value0: 26e3}, {
            date: new Date(2013, 10),
            value: 4e4,
            value0: 3e4
        }, {date: new Date(2013, 11), value: 2e4, value0: 25e3}, {
            date: new Date(2014, 0),
            value: 5e3,
            value0: 13e3
        }, {date: new Date(2014, 1), value: 3e3, value0: 13e3}, {
            date: new Date(2014, 2),
            value: 1800,
            value0: 13e3
        }, {date: new Date(2014, 3), value: 10400, value0: 13e3}, {
            date: new Date(2014, 4),
            value: 25500,
            value0: 13e3
        }, {date: new Date(2014, 5), value: 2100, value0: 13e3}, {
            date: new Date(2014, 6),
            value: 6500,
            value0: 13e3
        }, {date: new Date(2014, 7), value: 1100, value0: 13e3}, {
            date: new Date(2014, 8),
            value: 17200,
            value0: 13e3
        }, {date: new Date(2014, 9), value: 26900, value0: 13e3}, {
            date: new Date(2014, 10),
            value: 14100,
            value0: 13e3
        }, {date: new Date(2014, 11), value: 35300, value0: 13e3}, {
            ...
            value: 49800,
            value0: 13e3
        }], n = a.getChartColorProfile(), r = AmCharts.makeChart("amchart", {
            type: "serial",
            theme: "blur",
            marginTop: 15,
            marginRight: 15,
            dataProvider: o,
            categoryField: "date",
            categoryAxis: {parseDates: !0, gridAlpha: 0, color: n.fontColors, axisColor: n.axisColors},
            valueAxes: [{minVerticalGap: 50, gridAlpha: 0, color: n.fontColors, axisColor: n.axisColors}],
            graphs: [{
                id: "g0",
                bullet: "none",
            ...
            zoomOutText: "",
            pathToImages: s.images.amChart
        });
        t.watchAxisChartStyleChanges(e, r), r.addListener("rendered", l), l(), r.zoomChart && r.zoomChart()
    }

    angular.module("BlurAdmin.pages.dashboard").controller("DashboardLineChartCtrl", e), e.$inject = ["$scope", "tplSkinManager", "tplSkinChartWatcherHelper", "layoutColors", "layoutPaths"]
}(), function () {
    "use strict";
    function e() {
        return {
    ...
    function e(e, a, t, i) {
        ...
        e.charts = [{
            ...
            stats: "178,391",
            icon: "face"
        }, {color: "rgba(255,255,255,0.4)", description: "Returned", stats: "32,592", icon: "refresh"}], i(function () {
            l(), o()
        }, 1e3)
    }

    angular.module("BlurAdmin.pages.dashboard").controller("DashboardPieChartCtrl", e), e.$inject = ["$scope", "$element", "$window", "$timeout"]
}(), function () {
    "use strict";
    function e() {
        return {
    ...
    "use strict";
    function e(e) {
        e.marks = [{id: 0, color: "default"}, {id: 1, color: "primary"}, {id: 2, color: "success"}, {
            id: 3,
            color: "warning"
        }, {id: 4, color: "danger"}], e.todoList = [{
            text: "Check me out",
            edit: !1,
            markId: 4
        }, {
            ...
            edit: !1,
            markId: 4
        }, {text: "Get in touch with akveo team", edit: !1, markId: 1}, {
            text: "Write email to business cat",
            edit: !1,
            markId: 3
        }, {text: "Have fun with blur admin", edit: !1, markId: 2}], e.getMarkColor = function (a) {
            return e.marks.filter(function (e) {
                    return e.id === a
                })[0].color || ""
        }, e.changeColor = function (a) {
            for (var t = 0; t < e.marks.length; ++t)if (e.marks[t].id === a.markId) {
                var i = t + 1 !== e.marks.length ? t + 1 : 0;
                return a.markId = e.marks[i].id, !1
            }
        }, e.blurOnEnter = function (e, a) {
            13 === e.which && (a.edit = !1)
        }, e.newTodoText = "", e.addToDoItem = function (a, t) {
            (t || 13 === a.which) && (e.todoList.unshift({
                text: e.newTodoText,
                edit: !1,
                markId: 0
            }), e.newTodoText = "")
    ...
    angular.module("BlurAdmin.pages.dashboard").controller("DashboardTodoCtrl", e), e.$inject = ["$scope"]
}(), function () {
    "use strict";
    function e() {
        return {
    ...
    "use strict";
    function e() {
        return {restrict: "E", templateUrl: "app/pages/dashboard/popularApp/popularApp.html"}
    }
    ...
    angular.module("BlurAdmin.pages.dashboard").service("popularApp1", e)
}(), function () {
    "use strict";
    function e() {
    }

    angular.module("BlurAdmin.pages.dashboard").service("dashboardTodo", e)
}(), function () {
    "use strict";
    function e(e, a) {
        var t = e.bgColorPalette;
        a.doughnutData = [{
            value: 2e3,
            color: t.white,
            highlight: t.whiteDark,
            label: "Ad Campaigns",
            percentage: 87,
            order: 0
        }, {
            ...
            value: 1200,
            color: t.silverTree,
            highlight: t.silverTreeDark,
            label: "Direct Traffic",
            percentage: 38,
            order: 2
        }, {value: 400, color: t.gossip, highlight: t.gossipDark, label: "Other", percentage: 17, order: 1}];
        var i = document.getElementById("chart-area").getContext("2d");
        window.myDoughnut = new Chart(i).Doughnut(a.doughnutData, {
            segmentShowStroke: !1,
    ...
    angular.module("BlurAdmin.pages.dashboard").controller("TrafficChartCtrl", e), e.$inject = ["layoutColors", "$scope"]
}(), function () {
    "use strict";
    function e() {
        return {
    ...
    function e(e, a, t, i) {
        ...
        function l(e) {
            AmCharts.makeChart("tempChart", {
                ...
                categoryField: "time",
                dataProvider: e,
                valueAxes: [{axisAlpha: .3, gridAlpha: 0}],
                graphs: [{
                    bullet: "square",
                    fillAlphas: .3,
                    fillColorsField: "lineColor",
                ...
                categoryAxis: {gridAlpha: 0, axisAlpha: .3}
            }).write("tempChart")
        }
        ...
        function o(a) {
            ...
            a.list.forEach(function (e, t) {
                ...
                i.getDate() !== s.days[s.days.length - 1].date.getDate() && s.days.push({date: i, timeTemp: []});
        ...
        var n = "http://api.openweathermap.org/data/2.5/forecast", r = "GET", d = "2de143494c0b295cca9337e1e96b00e0", c = 15;
    ...
    angular.module("BlurAdmin.pages.dashboard").controller("WeatherCtrl", e), e.$inject = ["$scope", "$http", "$timeout", "$element"]
}(), function () {
    "use strict";
    function e() {
        return {restrict: "EA", controller: "WeatherCtrl", templateUrl: "app/pages/dashboard/weather/weather.html"}
    }
    ...
    angular.module("BlurAdmin.pages.form").controller("WizardCtrl", e), e.$inject = ["$scope"]
}(), function () {
    "use strict";
    function e(e) {
        function a() {
            var e = document.getElementById("google-maps"), a = {
    ...
    angular.module("BlurAdmin.pages.maps").controller("GmapPageCtrl", e), e.$inject = ["$timeout"]
}(), function () {
    "use strict";
    function e(e, a, t) {
        var i = {};
        i.AD = {latitude: 42.5, longitude: 1.5}, i.AE = {latitude: 24, longitude: 54}, i.AF = {
            latitude: 33,
            longitude: 65
        }, i.AG = {latitude: 17.05, longitude: -61.8}, i.AI = {
            latitude: 18.25,
            longitude: -63.1667
        }, i.AL = {latitude: 41, longitude: 20}, i.AM = {latitude: 40, longitude: 45}, i.AN = {
            latitude: 12.25,
            longitude: -68.75
        }, i.AO = {latitude: -12.5, longitude: 18.5}, i.AP = {latitude: 35, longitude: 105}, i.AQ = {
            latitude: -90,
            longitude: 0
        }, i.AR = {latitude: -34, longitude: -64}, i.AS = {
            latitude: -14.3333,
            longitude: -170
        }, i.AT = {latitude: 47.3333, longitude: 13.3333}, i.AU = {
            latitude: -27,
            longitude: 133
        }, i.AW = {latitude: 12.5, longitude: -69.9667}, i.AZ = {latitude: 40.5, longitude: 47.5}, i.BA = {
            latitude: 44,
            longitude: 18
        }, i.BB = {latitude: 13.1667, longitude: -59.5333}, i.BD = {
            latitude: 24,
            longitude: 90
        }, i.BE = {latitude: 50.8333, longitude: 4}, i.BF = {latitude: 13, longitude: -2}, i.BG = {
            latitude: 43,
            longitude: 25
        }, i.BH = {latitude: 26, longitude: 50.55}, i.BI = {latitude: -3.5, longitude: 30}, i.BJ = {
            latitude: 9.5,
            longitude: 2.25
        }, i.BM = {latitude: 32.3333, longitude: -64.75}, i.BN = {
            latitude: 4.5,
            longitude: 114.6667
        }, i.BO = {latitude: -17, longitude: -65}, i.BR = {latitude: -10, longitude: -55}, i.BS = {
            latitude: 24.25,
            longitude: -76
        }, i.BT = {latitude: 27.5, longitude: 90.5}, i.BV = {latitude: -54.4333, longitude: 3.4}, i.BW = {
            latitude: -22,
            longitude: 24
        }, i.BY = {latitude: 53, longitude: 28}, i.BZ = {latitude: 17.25, longitude: -88.75}, i.CA = {
            latitude: 54,
            longitude: -100
        }, i.CC = {latitude: -12.5, longitude: 96.8333}, i.CD = {latitude: 0, longitude: 25}, i.CF = {
            latitude: 7,
            longitude: 21
        }, i.CG = {latitude: -1, longitude: 15}, i.CH = {latitude: 47, longitude: 8}, i.CI = {
            latitude: 8,
            longitude: -5
        }, i.CK = {latitude: -21.2333, longitude: -159.7667}, i.CL = {
            latitude: -30,
            longitude: -71
        }, i.CM = {latitude: 6, longitude: 12}, i.CN = {latitude: 35, longitude: 105}, i.CO = {
            latitude: 4,
            longitude: -72
        }, i.CR = {latitude: 10, longitude: -84}, i.CU = {latitude: 21.5, longitude: -80}, i.CV = {
            latitude: 16,
            longitude: -24
        }, i.CX = {latitude: -10.5, longitude: 105.6667}, i.CY = {latitude: 35, longitude: 33}, i.CZ = {
            latitude: 49.75,
            longitude: 15.5
        }, i.DE = {latitude: 51, longitude: 9}, i.DJ = {latitude: 11.5, longitude: 43}, i.DK = {
            latitude: 56,
            longitude: 10
        }, i.DM = {latitude: 15.4167, longitude: -61.3333}, i.DO = {
            latitude: 19,
            longitude: -70.6667
        }, i.DZ = {latitude: 28, longitude: 3}, i.EC = {latitude: -2, longitude: -77.5}, i.EE = {
            latitude: 59,
            longitude: 26
        }, i.EG = {latitude: 27, longitude: 30}, i.EH = {latitude: 24.5, longitude: -13}, i.ER = {
            latitude: 15,
            longitude: 39
        }, i.ES = {latitude: 40, longitude: -4}, i.ET = {latitude: 8, longitude: 38}, i.EU = {
            latitude: 47,
            longitude: 8
        }, i.FI = {latitude: 62, longitude: 26}, i.FJ = {latitude: -18, longitude: 175}, i.FK = {
            latitude: -51.75,
            longitude: -59
        }, i.FM = {latitude: 6.9167, longitude: 158.25}, i.FO = {latitude: 62, longitude: -7}, i.FR = {
            latitude: 46,
            longitude: 2
        }, i.GA = {latitude: -1, longitude: 11.75}, i.GB = {latitude: 54, longitude: -2}, i.GD = {
            latitude: 12.1167,
            longitude: -61.6667
        }, i.GE = {latitude: 42, longitude: 43.5}, i.GF = {latitude: 4, longitude: -53}, i.GH = {
            latitude: 8,
            longitude: -2
        }, i.GI = {latitude: 36.1833, longitude: -5.3667}, i.GL = {
            latitude: 72,
            longitude: -40
        }, i.GM = {latitude: 13.4667, longitude: -16.5667}, i.GN = {
            latitude: 11,
            longitude: -10
        }, i.GP = {latitude: 16.25, longitude: -61.5833}, i.GQ = {latitude: 2, longitude: 10}, i.GR = {
            latitude: 39,
            longitude: 22
        }, i.GS = {latitude: -54.5, longitude: -37}, i.GT = {
            latitude: 15.5,
            longitude: -90.25
        }, i.GU = {latitude: 13.4667, longitude: 144.7833}, i.GW = {latitude: 12, longitude: -15}, i.GY = {
            latitude: 5,
            longitude: -59
        }, i.HK = {latitude: 22.25, longitude: 114.1667}, i.HM = {
            latitude: -53.1,
            longitude: 72.5167
        }, i.HN = {latitude: 15, longitude: -86.5}, i.HR = {latitude: 45.1667, longitude: 15.5}, i.HT = {
            latitude: 19,
            longitude: -72.4167
        }, i.HU = {latitude: 47, longitude: 20}, i.ID = {latitude: -5, longitude: 120}, i.IE = {
            latitude: 53,
            longitude: -8
        }, i.IL = {latitude: 31.5, longitude: 34.75},i.IN = {latitude: 20, longitude: 77},i.IO = {
            latitude: -6,
            longitude: 71.5
        },i.IQ = {latitude: 33, longitude: 44},i.IR = {latitude: 32, longitude: 53},i.IS = {
            latitude: 65,
            longitude: -18
        },i.IT = {latitude: 42.8333, longitude: 12.8333},i.JM = {
            latitude: 18.25,
            longitude: -77.5
        },i.JO = {latitude: 31, longitude: 36},i.JP = {latitude: 36, longitude: 138},i.KE = {
            latitude: 1,
            longitude: 38
        },i.KG = {latitude: 41, longitude: 75},i.KH = {latitude: 13, longitude: 105},i.KI = {
            latitude: 1.4167,
            longitude: 173
        },i.KM = {latitude: -12.1667, longitude: 44.25},i.KN = {
            latitude: 17.3333,
            longitude: -62.75
        },i.KP = {latitude: 40, longitude: 127},i.KR = {latitude: 37, longitude: 127.5},i.KW = {
            latitude: 29.3375,
            longitude: 47.6581
        },i.KY = {latitude: 19.5, longitude: -80.5},i.KZ = {latitude: 48, longitude: 68},i.LA = {
            latitude: 18,
            longitude: 105
        },i.LB = {latitude: 33.8333, longitude: 35.8333},i.LC = {
            latitude: 13.8833,
            longitude: -61.1333
        },i.LI = {latitude: 47.1667, longitude: 9.5333},i.LK = {latitude: 7, longitude: 81},i.LR = {
            latitude: 6.5,
            longitude: -9.5
        },i.LS = {latitude: -29.5, longitude: 28.5},i.LT = {latitude: 55, longitude: 24},i.LU = {
            latitude: 49.75,
            longitude: 6
        },i.LV = {latitude: 57, longitude: 25},i.LY = {latitude: 25, longitude: 17},i.MA = {
            latitude: 32,
            longitude: -5
        },i.MC = {latitude: 43.7333, longitude: 7.4},i.MD = {latitude: 47, longitude: 29},i.ME = {
            latitude: 42.5,
            longitude: 19.4
        },i.MG = {latitude: -20, longitude: 47},i.MH = {latitude: 9, longitude: 168},i.MK = {
            latitude: 41.8333,
            longitude: 22
        },i.ML = {latitude: 17, longitude: -4},i.MM = {latitude: 22, longitude: 98},i.MN = {
            latitude: 46,
            longitude: 105
        },i.MO = {latitude: 22.1667, longitude: 113.55},i.MP = {
            latitude: 15.2,
            longitude: 145.75
        },i.MQ = {latitude: 14.6667, longitude: -61},i.MR = {latitude: 20, longitude: -12},i.MS = {
            latitude: 16.75,
            longitude: -62.2
        },i.MT = {latitude: 35.8333, longitude: 14.5833},i.MU = {
            latitude: -20.2833,
            longitude: 57.55
        },i.MV = {latitude: 3.25, longitude: 73},i.MW = {latitude: -13.5, longitude: 34},i.MX = {
            latitude: 23,
            longitude: -102
        },i.MY = {latitude: 2.5, longitude: 112.5},i.MZ = {latitude: -18.25, longitude: 35},i.NA = {
            latitude: -22,
            longitude: 17
        },i.NC = {latitude: -21.5, longitude: 165.5},i.NE = {latitude: 16, longitude: 8},i.NF = {
            latitude: -29.0333,
            longitude: 167.95
        },i.NG = {latitude: 10, longitude: 8},i.NI = {latitude: 13, longitude: -85},i.NL = {
            latitude: 52.5,
            longitude: 5.75
        },i.NO = {latitude: 62, longitude: 10},i.NP = {latitude: 28, longitude: 84},i.NR = {
            latitude: -.5333,
            longitude: 166.9167
        },i.NU = {latitude: -19.0333, longitude: -169.8667},i.NZ = {latitude: -41, longitude: 174},i.OM = {
            latitude: 21,
            longitude: 57
        },i.PA = {latitude: 9, longitude: -80},i.PE = {latitude: -10, longitude: -76},i.PF = {
            latitude: -15,
            longitude: -140
        },i.PG = {latitude: -6, longitude: 147},i.PH = {latitude: 13, longitude: 122},i.PK = {
            latitude: 30,
            longitude: 70
        },i.PL = {latitude: 52, longitude: 20},i.PM = {latitude: 46.8333, longitude: -56.3333},i.PR = {
            latitude: 18.25,
            longitude: -66.5
        },i.PS = {latitude: 32, longitude: 35.25},i.PT = {latitude: 39.5, longitude: -8},i.PW = {
            latitude: 7.5,
            longitude: 134.5
        },i.PY = {latitude: -23, longitude: -58},i.QA = {latitude: 25.5, longitude: 51.25},i.RE = {
            latitude: -21.1,
            longitude: 55.6
        },i.RO = {latitude: 46, longitude: 25},i.RS = {latitude: 44, longitude: 21},i.RU = {
            latitude: 60,
            longitude: 100
        },i.RW = {latitude: -2, longitude: 30},i.SA = {latitude: 25, longitude: 45},i.SB = {
            latitude: -8,
            longitude: 159
        },i.SC = {latitude: -4.5833, longitude: 55.6667},i.SD = {latitude: 15, longitude: 30},i.SE = {
            latitude: 62,
            longitude: 15
        },i.SG = {latitude: 1.3667, longitude: 103.8},i.SH = {latitude: -15.9333, longitude: -5.7},i.SI = {
            latitude: 46,
            longitude: 15
        },i.SJ = {latitude: 78, longitude: 20},i.SK = {latitude: 48.6667, longitude: 19.5},i.SL = {
            latitude: 8.5,
            longitude: -11.5
        },i.SM = {latitude: 43.7667, longitude: 12.4167},i.SN = {latitude: 14, longitude: -14},i.SO = {
            latitude: 10,
            longitude: 49
        },i.SR = {latitude: 4, longitude: -56},i.ST = {latitude: 1, longitude: 7},i.SV = {
            latitude: 13.8333,
            longitude: -88.9167
        },i.SY = {latitude: 35, longitude: 38},i.SZ = {latitude: -26.5, longitude: 31.5},i.TC = {
            latitude: 21.75,
            longitude: -71.5833
        },i.TD = {latitude: 15, longitude: 19},i.TF = {latitude: -43, longitude: 67},i.TG = {
            latitude: 8,
            longitude: 1.1667
        },i.TH = {latitude: 15, longitude: 100},i.TJ = {latitude: 39, longitude: 71},i.TK = {
            latitude: -9,
            longitude: -172
        },i.TM = {latitude: 40, longitude: 60},i.TN = {latitude: 34, longitude: 9},i.TO = {
            latitude: -20,
            longitude: -175
        },i.TR = {latitude: 39, longitude: 35},i.TT = {latitude: 11, longitude: -61},i.TV = {
            latitude: -8,
            longitude: 178
        },i.TW = {latitude: 23.5, longitude: 121},i.TZ = {latitude: -6, longitude: 35},i.UA = {
            latitude: 49,
            longitude: 32
        },i.UG = {latitude: 1, longitude: 32},i.UM = {latitude: 19.2833, longitude: 166.6},i.US = {
            latitude: 38,
            longitude: -97
        },i.UY = {latitude: -33, longitude: -56},i.UZ = {latitude: 41, longitude: 64},i.VA = {
            latitude: 41.9,
            longitude: 12.45
        },i.VC = {latitude: 13.25, longitude: -61.2},i.VE = {latitude: 8, longitude: -66},i.VG = {
            latitude: 18.5,
            longitude: -64.5
        },i.VI = {latitude: 18.3333, longitude: -64.8333},i.VN = {latitude: 16, longitude: 106},i.VU = {
            latitude: -16,
            longitude: 167
        },i.WF = {latitude: -13.3, longitude: -176.2},i.WS = {
            latitude: -13.5833,
            longitude: -172.3333
        },i.YE = {latitude: 15, longitude: 48},i.YT = {latitude: -12.8333, longitude: 45.1667},i.ZA = {
            latitude: -29,
            longitude: 24
        },i.ZM = {latitude: -15, longitude: 30},i.ZW = {latitude: -20, longitude: 30};
        for (var s, l = [{code: "AF", name: "Afghanistan", value: 32358260, color: e.primaryDark}, {
            code: "AL",
            name: "Albania",
            value: 3215988,
            color: e.warning
        }, {code: "DZ", name: "Algeria", value: 35980193, color: e.danger}, {
            code: "AO",
            name: "Angola",
            value: 19618432,
            color: e.danger
        }, {code: "AR", name: "Argentina", value: 40764561, color: e.success}, {
            code: "AM",
            name: "Armenia",
            value: 3100236,
            color: e.warning
        }, {code: "AU", name: "Australia", value: 22605732, color: e.warningDark}, {
            code: "AT",
            name: "Austria",
            value: 8413429,
            color: e.warning
        }, {code: "AZ", name: "Azerbaijan", value: 9306023, color: e.warning}, {
            code: "BH",
            name: "Bahrain",
            value: 1323535,
            color: e.primaryDark
        }, {code: "BD", name: "Bangladesh", value: 150493658, color: e.primaryDark}, {
            code: "BY",
            name: "Belarus",
            value: 9559441,
            color: e.warning
        }, {code: "BE", name: "Belgium", value: 10754056, color: e.warning}, {
            code: "BJ",
            name: "Benin",
            value: 9099922,
            color: e.danger
        }, {code: "BT", name: "Bhutan", value: 738267, color: e.primaryDark}, {
            code: "BO",
            name: "Bolivia",
            value: 10088108,
            color: e.success
        }, {code: "BA", name: "Bosnia and Herzegovina", value: 3752228, color: e.warning}, {
            code: "BW",
            name: "Botswana",
            value: 2030738,
            color: e.danger
        }, {code: "BR", name: "Brazil", value: 196655014, color: e.success}, {
            code: "BN",
            name: "Brunei",
            value: 405938,
            color: e.primaryDark
        }, {code: "BG", name: "Bulgaria", value: 7446135, color: e.warning}, {
            code: "BF",
            name: "Burkina Faso",
            value: 16967845,
            color: e.danger
        }, {code: "BI", name: "Burundi", value: 8575172, color: e.danger}, {
            code: "KH",
            name: "Cambodia",
            value: 14305183,
            color: e.primaryDark
        }, {code: "CM", name: "Cameroon", value: 20030362, color: e.danger}, {
            code: "CA",
            name: "Canada",
            value: 34349561,
            color: e.primary
        }, {code: "CV", name: "Cape Verde", value: 500585, color: e.danger}, {
            code: "CF",
            name: "Central African Rep.",
            value: 4486837,
            color: e.danger
        }, {code: "TD", name: "Chad", value: 11525496, color: e.danger}, {
            code: "CL",
            name: "Chile",
            value: 17269525,
            color: e.success
        }, {code: "CN", name: "China", value: 1347565324, color: e.primaryDark}, {
            code: "CO",
            name: "Colombia",
            value: 46927125,
            color: e.success
        }, {code: "KM", name: "Comoros", value: 753943, color: e.danger}, {
            code: "CD",
            name: "Congo, Dem. Rep.",
            value: 67757577,
            color: e.danger
        }, {code: "CG", name: "Congo, Rep.", value: 4139748, color: e.danger}, {
            code: "CR",
            name: "Costa Rica",
            value: 4726575,
            color: e.primary
        }, {code: "CI", name: "Cote d'Ivoire", value: 20152894, color: e.danger}, {
            code: "HR",
            name: "Croatia",
            value: 4395560,
            color: e.warning
        }, {code: "CU", name: "Cuba", value: 11253665, color: e.primary}, {
            code: "CY",
            name: "Cyprus",
            value: 1116564,
            color: e.warning
        }, {code: "CZ", name: "Czech Rep.", value: 10534293, color: e.warning}, {
            code: "DK",
            name: "Denmark",
            value: 5572594,
            color: e.warning
        }, {code: "DJ", name: "Djibouti", value: 905564, color: e.danger}, {
            code: "DO",
            name: "Dominican Rep.",
            value: 10056181,
            color: e.primary
        }, {code: "EC", name: "Ecuador", value: 14666055, color: e.success}, {
            code: "EG",
            name: "Egypt",
            value: 82536770,
            color: e.danger
        }, {code: "SV", name: "El Salvador", value: 6227491, color: e.primary}, {
            code: "GQ",
            name: "Equatorial Guinea",
            value: 720213,
            color: e.danger
        }, {code: "ER", name: "Eritrea", value: 5415280, color: e.danger}, {
            code: "EE",
            name: "Estonia",
            value: 1340537,
            color: e.warning
        }, {code: "ET", name: "Ethiopia", value: 84734262, color: e.danger}, {
            code: "FJ",
            name: "Fiji",
            value: 868406,
            color: e.warningDark
        }, {code: "FI", name: "Finland", value: 5384770, color: e.warning}, {
            code: "FR",
            name: "France",
            value: 63125894,
            color: e.warning
        }, {code: "GA", name: "Gabon", value: 1534262, color: e.danger}, {
            code: "GM",
            name: "Gambia",
            value: 1776103,
            color: e.danger
        }, {code: "GE", name: "Georgia", value: 4329026, color: e.warning}, {
            code: "DE",
            name: "Germany",
            value: 82162512,
            color: e.warning
        }, {code: "GH", name: "Ghana", value: 24965816, color: e.danger}, {
            code: "GR",
            name: "Greece",
            value: 11390031,
            color: e.warning
        }, {code: "GT", name: "Guatemala", value: 14757316, color: e.primary}, {
            code: "GN",
            name: "Guinea",
            value: 10221808,
            color: e.danger
        }, {code: "GW", name: "Guinea-Bissau", value: 1547061, color: e.danger}, {
            code: "GY",
            name: "Guyana",
            value: 756040,
            color: e.success
        }, {code: "HT", name: "Haiti", value: 10123787, color: e.primary}, {
            code: "HN",
            name: "Honduras",
            value: 7754687,
            color: e.primary
        }, {code: "HK", name: "Hong Kong, China", value: 7122187, color: e.primaryDark}, {
            code: "HU",
            name: "Hungary",
            value: 9966116,
            color: e.warning
        }, {code: "IS", name: "Iceland", value: 324366, color: e.warning}, {
            code: "IN",
            name: "India",
            value: 1241491960,
            color: e.primaryDark
        }, {code: "ID", name: "Indonesia", value: 242325638, color: e.primaryDark}, {
            code: "IR",
            name: "Iran",
            value: 74798599,
            color: e.primaryDark
        }, {code: "IQ", name: "Iraq", value: 32664942, color: e.primaryDark}, {
            code: "IE",
            name: "Ireland",
            value: 4525802,
            color: e.warning
        }, {code: "IL", name: "Israel", value: 7562194, color: e.primaryDark}, {
            code: "IT",
            name: "Italy",
            value: 60788694,
            color: e.warning
        }, {code: "JM", name: "Jamaica", value: 2751273, color: e.primary}, {
            code: "JP",
            name: "Japan",
            value: 126497241,
            color: e.primaryDark
        }, {code: "JO", name: "Jordan", value: 6330169, color: e.primaryDark}, {
            code: "KZ",
            name: "Kazakhstan",
            value: 16206750,
            color: e.primaryDark
        }, {code: "KE", name: "Kenya", value: 41609728, color: e.danger}, {
            code: "KP",
            name: "Korea, Dem. Rep.",
            value: 24451285,
            color: e.primaryDark
        }, {code: "KR", name: "Korea, Rep.", value: 48391343, color: e.primaryDark}, {
            code: "KW",
            name: "Kuwait",
            value: 2818042,
            color: e.primaryDark
        }, {code: "KG", name: "Kyrgyzstan", value: 5392580, color: e.primaryDark}, {
            code: "LA",
            name: "Laos",
            value: 6288037,
            color: e.primaryDark
        }, {code: "LV", name: "Latvia", value: 2243142, color: e.warning}, {
            code: "LB",
            name: "Lebanon",
            value: 4259405,
            color: e.primaryDark
        }, {code: "LS", name: "Lesotho", value: 2193843, color: e.danger}, {
            code: "LR",
            name: "Liberia",
            value: 4128572,
            color: e.danger
        }, {code: "LY", name: "Libya", value: 6422772, color: e.danger}, {
            code: "LT",
            name: "Lithuania",
            value: 3307481,
            color: e.warning
        }, {code: "LU", name: "Luxembourg", value: 515941, color: e.warning}, {
            code: "MK",
            name: "Macedonia, FYR",
            value: 2063893,
            color: e.warning
        }, {code: "MG", name: "Madagascar", value: 21315135, color: e.danger}, {
            code: "MW",
            name: "Malawi",
            value: 15380888,
            color: e.danger
        }, {code: "MY", name: "Malaysia", value: 28859154, color: e.primaryDark}, {
            code: "ML",
            name: "Mali",
            value: 15839538,
            color: e.danger
        }, {code: "MR", name: "Mauritania", value: 3541540, color: e.danger}, {
            code: "MU",
            name: "Mauritius",
            value: 1306593,
            color: e.danger
        }, {code: "MX", name: "Mexico", value: 114793341, color: e.primary}, {
            code: "MD",
            name: "Moldova",
            value: 3544864,
            color: e.warning
        }, {code: "MN", name: "Mongolia", value: 2800114, color: e.primaryDark}, {
            code: "ME",
            name: "Montenegro",
            value: 632261,
            color: e.warning
        }, {code: "MA", name: "Morocco", value: 32272974, color: e.danger}, {
            code: "MZ",
            name: "Mozambique",
            value: 23929708,
            color: e.danger
        }, {code: "MM", name: "Myanmar", value: 48336763, color: e.primaryDark}, {
            code: "NA",
            name: "Namibia",
            value: 2324004,
            color: e.danger
        }, {code: "NP", name: "Nepal", value: 30485798, color: e.primaryDark}, {
            code: "NL",
            name: "Netherlands",
            value: 16664746,
            color: e.warning
        }, {code: "NZ", name: "New Zealand", value: 4414509, color: e.warningDark}, {
            code: "NI",
            name: "Nicaragua",
            value: 5869859,
            color: e.primary
        }, {code: "NE", name: "Niger", value: 16068994, color: e.danger}, {
            code: "NG",
            name: "Nigeria",
            value: 162470737,
            color: e.danger
        }, {code: "NO", name: "Norway", value: 4924848, color: e.warning}, {
            code: "OM",
            name: "Oman",
            value: 2846145,
            color: e.primaryDark
        }, {code: "PK", name: "Pakistan", value: 176745364, color: e.primaryDark}, {
            code: "PA",
            name: "Panama",
            value: 3571185,
            color: e.primary
        }, {code: "PG", name: "Papua New Guinea", value: 7013829, color: e.warningDark}, {
            code: "PY",
            name: "Paraguay",
            value: 6568290,
            color: e.success
        }, {code: "PE", name: "Peru", value: 29399817, color: e.success}, {
            code: "PH",
            name: "Philippines",
            value: 94852030,
            color: e.primaryDark
        }, {code: "PL", name: "Poland", value: 38298949, color: e.warning}, {
            code: "PT",
            name: "Portugal",
            value: 10689663,
            color: e.warning
        }, {code: "PR", name: "Puerto Rico", value: 3745526, color: e.primary}, {
            code: "QA",
            name: "Qatar",
            value: 1870041,
            color: e.primaryDark
        }, {code: "RO", name: "Romania", value: 21436495, color: e.warning}, {
            code: "RU",
            name: "Russia",
            value: 142835555,
            color: e.warning
        }, {code: "RW", name: "Rwanda", value: 10942950, color: e.danger}, {
            code: "SA",
            name: "Saudi Arabia",
            value: 28082541,
            color: e.primaryDark
        }, {code: "SN", name: "Senegal", value: 12767556, color: e.danger}, {
            code: "RS",
            name: "Serbia",
            value: 9853969,
            color: e.warning
        }, {code: "SL", name: "Sierra Leone", value: 5997486, color: e.danger}, {
            code: "SG",
            name: "Singapore",
            value: 5187933,
            color: e.primaryDark
        }, {code: "SK", name: "Slovak Republic", value: 5471502, color: e.warning}, {
            code: "SI",
            name: "Slovenia",
            value: 2035012,
            color: e.warning
        }, {code: "SB", name: "Solomon Islands", value: 552267, color: e.warningDark}, {
            code: "SO",
            name: "Somalia",
            value: 9556873,
            color: e.danger
        }, {code: "ZA", name: "South Africa", value: 50459978, color: e.danger}, {
            code: "ES",
            name: "Spain",
            value: 46454895,
            color: e.warning
        }, {code: "LK", name: "Sri Lanka", value: 21045394, color: e.primaryDark}, {
            code: "SD",
            name: "Sudan",
            value: 34735288,
            color: e.danger
        }, {code: "SR", name: "Suriname", value: 529419, color: e.success}, {
            code: "SZ",
            name: "Swaziland",
            value: 1203330,
            color: e.danger
        }, {code: "SE", name: "Sweden", value: 9440747, color: e.warning}, {
            code: "CH",
            name: "Switzerland",
            value: 7701690,
            color: e.warning
        }, {code: "SY", name: "Syria", value: 20766037, color: e.primaryDark}, {
            code: "TW",
            name: "Taiwan",
            value: 23072e3,
            color: e.primaryDark
        }, {code: "TJ", name: "Tajikistan", value: 6976958, color: e.primaryDark}, {
            code: "TZ",
            name: "Tanzania",
            value: 46218486,
            color: e.danger
        }, {code: "TH", name: "Thailand", value: 69518555, color: e.primaryDark}, {
            code: "TG",
            name: "Togo",
            value: 6154813,
            color: e.danger
        }, {code: "TT", name: "Trinidad and Tobago", value: 1346350, color: e.primary}, {
            code: "TN",
            name: "Tunisia",
            value: 10594057,
            color: e.danger
        }, {code: "TR", name: "Turkey", value: 73639596, color: e.warning}, {
            code: "TM",
            name: "Turkmenistan",
            value: 5105301,
            color: e.primaryDark
        }, {code: "UG", name: "Uganda", value: 34509205, color: e.danger}, {
            code: "UA",
            name: "Ukraine",
            value: 45190180,
            color: e.warning
        }, {code: "AE", name: "United Arab Emirates", value: 7890924, color: e.primaryDark}, {
            code: "GB",
            name: "United Kingdom",
            value: 62417431,
            color: e.warning
        }, {code: "US", name: "United States", value: 313085380, color: e.primary}, {
            code: "UY",
            name: "Uruguay",
            value: 3380008,
            color: e.success
        }, {code: "UZ", name: "Uzbekistan", value: 27760267, color: e.primaryDark}, {
            code: "VE",
            name: "Venezuela",
            value: 29436891,
            color: e.success
        }, {code: "PS", name: "West Bank and Gaza", value: 4152369, color: e.primaryDark}, {
            code: "VN",
            name: "Vietnam",
            value: 88791996,
            color: e.primaryDark
        }, {code: "YE", name: "Yemen, Rep.", value: 24799880, color: e.primaryDark}, {
            code: "ZM",
            name: "Zambia",
            value: 13474959,
            color: e.danger
            ...
            value: 12754378,
            color: e.danger
        }], o = 3, n = 70, r = 1 / 0, d = -(1 / 0), c = 0; c < l.length; c++) {
            var u = l[c].value;
            r > u && (r = u), u > d && (d = u)
        }
        AmCharts.theme = AmCharts.themes.blur, s = new AmCharts.AmMap, s.addTitle("Population of the World in 2011", 14), s.addTitle("source: Gapminder", 11), s.areasSettings = {
            unlistedAreasColor: "#000000",
            unlistedAreasAlpha: .1
        }, s.imagesSettings.balloonText = '<span style="font-size:14px;"><b>[[title]]</b>: [[value]]</span>', s.pathToImages = t.images.amMap;
        for (var p = {
            mapVar: AmCharts.maps.worldLow,
            images: []
        }, m = n * n * 2 * Math.PI, g = o * o * 2 * Math.PI, c = 0; c < l.length; c++) {
            var b = l[c], u = b.value, h = (u - r) / (d - r) * (m - g) + g;
            g > h && (h = g);
            var v = Math.sqrt(h / (2 * Math.PI)), f = b.code;
            p.images.push({
                type: "circle",
                width: v,
                height: v,
                color: b.color,
                longitude: i[f].longitude,
                latitude: i[f].latitude,
                title: b.name,
                value: u
            })
        }
        s.dataProvider = p, s["export"] = {enabled: !0}, a(function () {
            s.write("map-bubbles")
        }, 100)
    }

    angular.module("BlurAdmin.pages.maps").controller("MapBubblePageCtrl", e), e.$inject = ["layoutColors", "$timeout", "layoutPaths"]
}(), function () {
    "use strict";
    function e(e) {
        function a() {
            ...
            L.tileLayer("http://{s}.tile.osm.org/{z}/{x}/{y}.png", {attribution: '&copy; <a href="http://osm.org/copyright">OpenStreetMap</a> contributors'}).addTo(e), L.marker([51.5, -.09]).addTo(e).bindPopup("A pretty CSS3 popup.<br> Easily customizable.").openPopup()
        }
    ...
    angular.module("BlurAdmin.pages.maps").controller("LeafletPageCtrl", e), e.$inject = ["$timeout"]
}(), function () {
    "use strict";
    function e(e, a, t) {
        var i = "M9,0C4.029,0,0,4.029,0,9s4.029,9,9,9s9-4.029,9-9S13.971,0,9,0z M9,15.93 c-3.83,0-6.93-3.1-6.93-6.93S5.17,2.07,9,2.07s6.93,3.1,6.93,6.93S12.83,15.93,9,15.93 M12.5,9c0,1.933-1.567,3.5-3.5,3.5S5.5,10.933,5.5,9S7.067,5.5,9,5.5 S12.5,7.067,12.5,9z", s = "M19.671,8.11l-2.777,2.777l-3.837-0.861c0.362-0.505,0.916-1.683,0.464-2.135c-0.518-0.517-1.979,0.278-2.305,0.604l-0.913,0.913L7.614,8.804l-2.021,2.021l2.232,1.061l-0.082,0.082l1.701,1.701l0.688-0.687l3.164,1.504L9.571,18.21H6.413l-1.137,1.138l3.6,0.948l1.83,1.83l0.947,3.598l1.137-1.137V21.43l3.725-3.725l1.504,3.164l-0.687,0.687l1.702,1.701l0.081-0.081l1.062,2.231l2.02-2.02l-0.604-2.689l0.912-0.912c0.326-0.326,1.121-1.789,0.604-2.306c-0.452-0.452-1.63,0.101-2.135,0.464l-0.861-3.838l2.777-2.777c0.947-0.947,3.599-4.862,2.62-5.839C24.533,4.512,20.618,7.163,19.671,8.11z";
        a(function () {
                ...
                dataProvider: {
                    ...
                    images: [{
                        ...
                        images: [{
                            ...
                            labelShiftX: 5,
                            color: e["default"],
                            labelColor: e["default"],
                            labelRollOverColor: e["default"],
                            labelFontSize: 20
                        }, {
                    ...
                    }, {svgPath: i, title: "Brussels", latitude: 50.8371, longitude: 4.3676}, {
                        svgPath: i,
                        title: "Prague",
                        latitude: 50.0878,
                        longitude: 14.4205
                    }, {svgPath: i, title: "Athens", latitude: 37.9792, longitude: 23.7166}, {
                        svgPath: i,
                        title: "Reykjavik",
                        latitude: 64.1353,
                        longitude: -21.8952
                    }, {svgPath: i, title: "Dublin", latitude: 53.3441, longitude: -6.2675}, {
                        svgPath: i,
                        title: "Oslo",
                        latitude: 59.9138,
                        longitude: 10.7387
                    }, {svgPath: i, title: "Lisbon", latitude: 38.7072, longitude: -9.1355}, {
                        svgPath: i,
                        title: "Moscow",
                        latitude: 55.7558,
                        longitude: 37.6176
                    }, {svgPath: i, title: "Belgrade", latitude: 44.8048, longitude: 20.4781}, {
                        svgPath: i,
                        title: "Bratislava",
                        latitude: 48.2116,
                        longitude: 17.1547
                    }, {svgPath: i, title: "Ljubljana", latitude: 46.0514, longitude: 14.506}, {
                        svgPath: i,
                        title: "Madrid",
                        latitude: 40.4167,
                        longitude: -3.7033
                    }, {svgPath: i, title: "Stockholm", latitude: 59.3328, longitude: 18.0645}, {
                        svgPath: i,
                        title: "Bern",
                        latitude: 46.948,
                        longitude: 7.4481
                    }, {svgPath: i, title: "Kiev", latitude: 50.4422, longitude: 30.5367}, {
                        svgPath: i,
                        title: "Paris",
                        latitude: 48.8567,
                        longitude: 2.351
                    }, {svgPath: i, title: "New York", latitude: 40.43, longitude: -74}]
                },
                areasSettings: {unlistedAreasColor: e.info},
                imagesSettings: {color: e.warningBg, selectedColor: e.warning},
                linesSettings: {color: e.warningBg, alpha: .8},
    ...
    angular.module("BlurAdmin.pages.maps").controller("MapLinesPageCtrl", e), e.$inject = ["layoutColors", "$timeout", "layoutPaths"]
}(), function () {
    "use strict";
    function e(e, a) {
    ...
    angular.module("BlurAdmin.pages.ui.buttons").controller("ButtonPageCtrl", e), e.$inject = ["$scope", "$timeout"]
}(), function () {
    "use strict";
    function e(e) {
        e.icons = {
            kameleonIcons: [{name: "Beach", img: "Beach"}, {name: "Bus", img: "Bus"}, {
                name: "Cheese",
                img: "Cheese"
            }, {name: "Desert", img: "Desert"}, {name: "Images", img: "Images"}, {
                name: "Magician",
                img: "Magician"
            }, {name: "Makeup", img: "Makeup"}, {name: "Programming", img: "Programming"}, {
                name: "Shop",
                img: "Shop"
            }, {name: "Surfer", img: "Surfer"}, {name: "Phone Booth", img: "Phone-Booth"}, {
                name: "Ninja",
                img: "Ninja"
            }, {name: "Apartment", img: "Apartment"}, {name: "Batman", img: "Batman"}, {
                name: "Medal",
                img: "Medal-2"
            }, {name: "Money", img: "Money-Increase"}, {name: "Street View", img: "Street-View"}, {
                name: "Student",
                img: "Student-3"
            }, {name: "Bell", img: "Bell"}, {name: "Woman", img: "Boss-5"}, {
                name: "Euro",
                img: "Euro-Coin"
            }, {name: "Chessboard", img: "Chessboard"}, {name: "Burglar", img: "Burglar"}, {
                name: "Dna",
                img: "Dna"
            }, {name: "Clipboard Plan", img: "Clipboard-Plan"}, {name: "Boss", img: "Boss-3"}, {
                name: "Key",
                img: "Key"
            }, {name: "Surgeon", img: "Surgeon"}, {name: "Hacker", img: "Hacker"}, {name: "Santa", img: "Santa"}],
            kameleonRoundedIcons: [{color: "success", img: "Apartment", name: "Apartment"}, {
                color: "warning",
                img: "Bus",
                name: "Bus"
    ...
    angular.module("BlurAdmin.pages.ui.icons").controller("IconsPageCtrl", e), e.$inject = ["$scope"]
}(), function () {
    "use strict";
    function e(e, a) {
        e.open = function (t, i) {
            a.open({
                animation: !0, templateUrl: t, size: i, resolve: {
                    items: function () {
                        return e.items
                    }
                }
    ...
    angular.module("BlurAdmin.pages.ui.notifications").controller("ModalsPageCtrl", e), e.$inject = ["$scope", "$uibModal"]
}(), function () {
    "use strict";
    function e(e, a, t) {
        ...
        e.types = ["success", "error", "info", "warning"], e.quotes = [{
            ...
            options: {allowHtml: !0}
        }, {title: "Ionic is <em>cool</em>", message: "Best mobile framework ever", options: {allowHtml: !0}}];
        var s = [];
        e.options = {
            autoDismiss: !1,
            positionClass: "toast-top-right",
            ...
            var t = Math.floor(Math.random() * e.types.length), i = Math.floor(Math.random() * e.quotes.length), l = e.types[t], o = e.quotes[i];
    ...
    angular.module("BlurAdmin.pages.ui.notifications").controller("NotificationsPageCtrl", e), e.$inject = ["$scope", "toastr", "toastrConfig"]
}(), function () {
    "use strict";
    function e(e, a, t, i) {
        return angular.extend({}, e, {
            link: function (e) {
                e.panelType = i.getActiveSkin().panelType, e.$on("tplSkinChanged", function () {
                    e.panelType = i.getActiveSkin().panelType
                })
            }, template: function (a, t) {
                var i = '<div  class="panel {{panelType}} full-invisible ' + (t.baPanelClass || "") + '" zoom-in ba-panel-blur>';
                return i += e.template(a, t), i += "</div>"
            }
        })
    }

    angular.module("BlurAdmin.theme").directive("baPanel", e), e.$inject = ["baPanel", "$document", "$window", "tplSkinManager"]
}(), function () {
    "use strict";
    function e() {
        return {
            restrict: "A", transclude: !0, template: function (e, a) {
    ...
    angular.module("BlurAdmin.theme").directive("baPanelBlur", e), e.$inject = ["baPanelBlurHelper", "$window", "$rootScope"]
}(), function () {
    "use strict";
    function e(e) {
        var a = e.defer(), t = getComputedStyle(document.body, ":before"), i = new Image;
        i.src = t.backgroundImage.replace(/url\((['"])?(.*?)\1\)/gi, "$2"), i.onerror = function () {
            ...
            if (!(640 >= e)) {
                var t, s, l = i.height / i.width, o = a / e;
    ...
    angular.module("BlurAdmin.theme").service("baPanelBlurHelper", e), e.$inject = ["$q"]
}(), function () {
    "use strict";
    function e(e) {
        return angular.extend({}, e, {
    ...
    angular.module("BlurAdmin.theme").directive("baPanelSelf", e), e.$inject = ["baPanel"]
}(), function () {
    "use strict";
    function e() {
        return {
    ...
    angular.module("BlurAdmin.theme.components").controller("baWizardCtrl", e), e.$inject = ["$scope"]
}(),function () {
    "use strict";
    function e() {
        return {
    ...
    angular.module("BlurAdmin.theme.components").directive("contentTop", e), e.$inject = ["$location", "$state"]
}(),function () {
    "use strict";
    function e() {
        return {restrict: "E", scope: {isMenuCollapsed: "="}, templateUrl: "app/theme/components/pageTop/pageTop.html"}
    }
    ...
    angular.module("BlurAdmin.theme.components").controller("MsgCenterCtrl", e), e.$inject = ["$scope", "$sce"]
}(),function () {
    "use strict";
    function e() {
        return {
    ...
    function e(e, a, t, i, s, l, o) {
        function n() {
            $.each(e.menuItems, function (e, a) {
                a.selected = 0 == ("#" + i.$$url).indexOf(a.root), a.expanded = a.expanded || a.selected, a.subMenu && $.each(a.subMenu, function (e, a) {
                    a.selected = 0 == ("#" + i.$$url).indexOf(a.root) && !a.disabled
                })
            })
        }

        e.menuItems = l.getMenuItems(), e.menuHeight = o[0].childNodes[0].clientHeight - 84, n(), e.$on("$locationChangeSuccess", function () {
            n()
        }), e.menuExpand = function () {
            e.$isMenuCollapsed = !1
        }, e.menuCollapse = function () {
            e.$isMenuCollapsed = !0
        }, $(window).resize(function () {
            var a = $(window).width() <= s.resWidthCollapseSidebar, t = !1;
            e.isMenuShouldCollapsed !== a && e.$apply(function () {
                e.menuHeight = o[0].childNodes[0].clientHeight - 84, e.$isMenuCollapsed = a, t = !0
            }), t || e.$apply(function () {
                e.menuHeight = o[0].childNodes[0].clientHeight - 84
            }), e.isMenuShouldCollapsed = a
        }), e.toggleSubMenu = function (a, i) {
            var s = $(a.currentTarget).next();
            e.$isMenuCollapsed ? (e.menuExpand(), i.expanded || t(function () {
                i.expanded = !i.expanded, s.slideToggle()
            })) : (i.expanded = !i.expanded, s.slideToggle())
        }, window.onclick = function () {
            t(function () {
                e.anySlideRight && (e.menuItems.map(function (e) {
                    return e.slideRight = !1
                }), e.anySlideRight = !1)
            }, 10)
        }, e.hoverItem = function (a) {
    ...
    angular.module("BlurAdmin.theme.components").controller("SidebarCtrl", e), e.$inject = ["$scope", "$rootScope", "$timeout", "$location", "layoutSizes", "sidebarService", "$element"]
}(),function () {
    "use strict";
    function e() {
        return {restrict: "E", templateUrl: "app/theme/components/sidebar/sidebar.html", controller: "SidebarCtrl"}
    }

    angular.module("BlurAdmin.theme.components").directive("sidebar", e)
}(),function () {
    "use strict";
    function e(e) {
        function a() {
            return e.get().filter(function (e) {
        ...
        var t = [{
            title: "Pages",
            icon: "ion-document",
            subMenu: [{title: "Sign In", root: "sign_in.html", blank: !0}, {
                title: "Sign Up",
                root: "sigin_up.html",
                blank: !0
            }, {title: "User Profile", root: "#/profile"}, {title: "404 Page", root: "404.html", blank: !0}]
        }, {
            title: "Menu Level 1",
            icon: "ion-ios-more",
            subMenu: [{title: "Menu Level 1.1", root: "#", disabled: !0}, {
                title: "Menu Level 1.2",
                subMenu: [{title: "Menu Level 1.2.1", root: "#", disabled: !0}]
            }]
        }];
        this.getMenuItems = function () {
            var e = a(), i = e.filter(function (e) {
                return 0 == e.level
            });
            return i.forEach(function (a) {
                var t = e.filter(function (e) {
                    return 1 == e.level && 0 === e.name.indexOf(a.name)
                });
                a.subMenu = t.length ? t : null
            }), i.concat(t)
        }
    }

    angular.module("BlurAdmin.theme.components").service("sidebarService", e), e.$inject = ["$state"]
}(),function () {
    "use strict";
    function e() {
        return {
    ...
    angular.module("BlurAdmin.theme").filter("appImage", e), e.$inject = ["layoutPaths"]
}(),function () {
    "use strict";
    function e(e) {
        return function (a) {
    ...
    angular.module("BlurAdmin.theme").filter("kameleonImg", e), e.$inject = ["layoutPaths"]
}(),function () {
    "use strict";
    function e(e) {
        return function (a, t) {
    ...
    angular.module("BlurAdmin.theme").filter("profilePicture", e), e.$inject = ["layoutPaths"]
}(),function () {
    "use strict";
    function e(e, a, t, i, s) {
        function l() {
        ...
        var o = t[0].getAttribute("id"), n = AmCharts.makeChart(o, {
            type: "serial",
            theme: "blur",
            dataProvider: [{lineColor: a.info, date: "2012-01-01", duration: 408}, {
                date: "2012-01-02",
                duration: 482
            }, {date: "2012-01-03", duration: 562}, {date: "2012-01-04", duration: 379}, {
                lineColor: a.warning,
                date: "2012-01-05",
                duration: 501
            ...
            valueAxes: [{duration: "mm", durationUnits: {hh: "h ", mm: "min"}, axisAlpha: 0}],
            graphs: [{
                bullet: "square",
                bulletBorderAlpha: 1,
            ...
            chartCursor: {categoryBalloonDateFormat: "YYYY MMM DD", cursorAlpha: 0, fullWidth: !0},
        ...
        i.watchAxisChartStyleChanges(e, n), n.addListener("dataUpdated", l)
    }

    angular.module("BlurAdmin.pages.charts.amCharts").controller("AreaChartCtrl", e), e.$inject = ["$scope", "layoutColors", "$element", "tplSkinChartWatcherHelper", "layoutPaths"]
}(),function () {
    "use strict";
    function e(e, a, t, i, s) {
        var l = t[0].getAttribute("id"), o = AmCharts.makeChart(l, {
            type: "serial",
            theme: "blur",
            dataProvider: [{country: "USA", visits: 3025, color: a.primary}, {
                country: "China",
                visits: 1882,
                color: a.danger
            }, {country: "Japan", visits: 1809, color: a.info}, {
                country: "Germany",
                visits: 1322,
                color: a.success
            }, {country: "UK", visits: 1122, color: a.warning}, {country: "France", visits: 1114, color: a["default"]}],
            valueAxes: [{axisAlpha: 0, position: "left", title: "Visitors from country"}],
            startDuration: 1,
            graphs: [{
        ...
        i.watchAxisChartStyleChanges(e, o)
    }

    angular.module("BlurAdmin.pages.charts.amCharts").controller("BarChartCtrl", e), e.$inject = ["$scope", "layoutColors", "$element", "tplSkinChartWatcherHelper", "layoutPaths"]
}(),function () {
    "use strict";
    function e(e, a, t) {
        var i = e[0].getAttribute("id");
        AmCharts.makeChart(i, {
            type: "serial",
            theme: "none",
            color: a["default"],
            dataDateFormat: "YYYY-MM-DD",
            ...
            graphs: [{
                ...
                color: a["default"],
                valueAxis: "v1",
                lineColor: a.primaryLight,
                fillColors: a.primaryLight,
                fillAlphas: .8,
                lineAlpha: .8,
                type: "column",
                title: "Actual Sales",
            ...
            legend: {useGraphSettings: !0, position: "top", color: "#fff"},
            balloon: {borderThickness: 1, shadowAlpha: 0},
            "export": {enabled: !0},
            dataProvider: [{date: "2013-01-16", market1: 71, market2: 75, sales1: 5, sales2: 8}, {
                date: "2013-01-17",
                market1: 74,
                market2: 78,
                sales1: 4,
    ...
    angular.module("BlurAdmin.pages.charts.amCharts").controller("combinedChartCtrl", e), e.$inject = ["$element", "layoutColors", "layoutPaths"]
}(),function () {
    "use strict";
    function e(e, a, t, i) {
        var s = a[0].getAttribute("id"), l = AmCharts.makeChart(s, {
            type: "funnel",
            theme: "blur",
            dataProvider: [{title: "Website visits", value: 300}, {
                title: "Downloads",
                value: 123
            }, {title: "Requested prices", value: 98}, {title: "Contaced", value: 72}, {
                title: "Purchased",
                value: 35
            }, {title: "Asked for support", value: 25}, {title: "Purchased more", value: 18}],
            titleField: "title",
            marginRight: 160,
            marginLeft: 15,
            labelPosition: "right",
        ...
        t.watchFunnelChanges(e, l)
    }

    angular.module("BlurAdmin.pages.charts.amCharts").controller("FunnelChartCtrl", e), e.$inject = ["$scope", "$element", "tplSkinChartWatcherHelper", "layoutPaths"]
}(),function () {
    "use strict";
    function e(e, a) {
        var t = a[0].getAttribute("id");
        AmCharts.makeChart(t, {
            type: "gantt",
            theme: "light",
            marginRight: 70,
            period: "hh",
            ...
            columnWidth: .5,
            valueAxis: {type: "date", minimum: 7, maximum: 31},
            brightnessStep: 10,
            graph: {fillAlphas: 1, balloonText: "<b>[[task]]</b>: [[open]] [[value]]"},
            rotate: !0,
            ...
            dataProvider: [{
                category: "John",
                segments: [{start: 7, duration: 2, color: "#46615e", task: "Task #1"}, {
                    duration: 2,
                    color: "#727d6f",
                    task: "Task #2"
                }, {duration: 2, color: "#8dc49f", task: "Task #3"}]
            }, {
                category: "Smith",
                segments: [{start: 10, duration: 2, color: "#727d6f", task: "Task #2"}, {
                    duration: 1,
                    color: "#8dc49f",
                    task: "Task #3"
                }, {duration: 4, color: "#46615e", task: "Task #1"}]
            }, {
                category: "Ben",
                segments: [{start: 12, duration: 2, color: "#727d6f", task: "Task #2"}, {
                    start: 16,
                    duration: 2,
                    color: "#FFE4C4",
                    task: "Task #4"
                ...
                category: "Mike",
                segments: [{start: 9, duration: 6, color: "#46615e", task: "Task #1"}, {
                    duration: 4,
                    color: "#727d6f",
                    task: "Task #2"
                }]
                ...
                category: "Lenny",
                segments: [{start: 8, duration: 1, color: "#8dc49f", task: "Task #3"}, {
                    duration: 4,
                    color: "#46615e",
                    task: "Task #1"
                }]
                ...
                category: "Scott",
                segments: [{start: 15, duration: 3, color: "#727d6f", task: "Task #2"}]
            }, {
                category: "Julia",
                segments: [{start: 9, duration: 2, color: "#46615e", task: "Task #1"}, {
                    duration: 1,
                    color: "#727d6f",
                    task: "Task #2"
                }, {duration: 8, color: "#8dc49f", task: "Task #3"}]
            }, {
                category: "Bob",
                segments: [{start: 9, duration: 8, color: "#727d6f", task: "Task #2"}, {
                    duration: 7,
                    color: "#8dc49f",
                    task: "Task #3"
                }]
                ...
                category: "Kendra",
                segments: [{start: 11, duration: 8, color: "#727d6f", task: "Task #2"}, {
                    start: 16,
                    duration: 2,
                    color: "#FFE4C4",
                    task: "Task #4"
                ...
                category: "Tom",
                segments: [{start: 9, duration: 4, color: "#46615e", task: "Task #1"}, {
                    duration: 3,
                    color: "#727d6f",
                    task: "Task #2"
                }, {duration: 5, color: "#8dc49f", task: "Task #3"}]
            }, {
                category: "Kyle",
                segments: [{start: 6, duration: 3, color: "#727d6f", task: "Task #2"}]
            }, {
                category: "Anita",
                segments: [{start: 12, duration: 2, color: "#727d6f", task: "Task #2"}, {
                    start: 16,
                ...
                category: "Jack",
                segments: [{start: 8, duration: 10, color: "#46615e", task: "Task #1"}, {
                    duration: 2,
                    color: "#727d6f",
                    task: "Task #2"
                }]
                ...
                category: "Aaron",
                segments: [{start: 18, duration: 2, color: "#727d6f", task: "Task #2"}, {
                    duration: 2,
                    color: "#FFE4C4",
                    task: "Task #4"
                }]
                ...
                category: "Alan",
                segments: [{start: 17, duration: 2, color: "#46615e", task: "Task #1"}, {
                    duration: 2,
                    color: "#727d6f",
                    task: "Task #2"
                }, {duration: 2, color: "#8dc49f", task: "Task #3"}]
                ...
                category: "Ruth",
                segments: [{start: 13, duration: 2, color: "#727d6f", task: "Task #2"}, {
                    duration: 1,
                    color: "#8dc49f",
                    task: "Task #3"
                }, {duration: 4, color: "#46615e", task: "Task #1"}]
                ...
                category: "Simon",
                segments: [{start: 10, duration: 3, color: "#727d6f", task: "Task #2"}, {
                    start: 17,
                    duration: 4,
                    color: "#FFE4C4",
                    task: "Task #4"
            ...
            valueScrollbar: {autoGridCount: !0},
            chartCursor: {
                cursorColor: "#55bb76",
    ...
    angular.module("BlurAdmin.pages.charts.amCharts").controller("ganttChartCtrl", e), e.$inject = ["layoutColors", "$element"]
}(),function () {
    "use strict";
    function e(e, a, t, i, s) {
        function l() {
        ...
        var o = t[0].getAttribute("id"), n = AmCharts.makeChart(o, {
            ...
            marginTop: 0,
            marginRight: 15,
            dataProvider: [{year: "1990", value: -.17}, {year: "1991", value: -.254}, {
                year: "1992",
                value: .019
            }, {year: "1993", value: -.063}, {year: "1994", value: .005}, {year: "1995", value: .077}, {
                year: "1996",
                value: .12
            }, {year: "1997", value: .011}, {year: "1998", value: .177}, {year: "1999", value: -.021}, {
                year: "2000",
                value: -.037
            }, {year: "2001", value: .03}, {year: "2002", value: .179}, {year: "2003", value: .2}, {
                year: "2004",
                value: .18
            }, {year: "2005", value: .21}],
            ...
            dataDateFormat: "YYYY",
            categoryField: "year",
            categoryAxis: {minPeriod: "YYYY", parseDates: !0, minorGridAlpha: .1, minorGridEnabled: !0},
            "export": {enabled: !0},
            creditsPosition: "bottom-right",
            pathToImages: s.images.amChart
        });
        i.watchAxisChartStyleChanges(e, n), n.addListener("rendered", l), n.zoomChart && n.zoomChart()
    }

    angular.module("BlurAdmin.pages.charts.amCharts").controller("LineChartCtrl", e), e.$inject = ["$scope", "layoutColors", "$element", "tplSkinChartWatcherHelper", "layoutPaths"]
}(),function () {
    "use strict";
    function e(e, a, t, i) {
        function s() {
            n.legend.addListener("rollOverItem", l)
        }
        ...
        var o = a[0].getAttribute("id"), n = AmCharts.makeChart(o, {
            type: "pie",
            startDuration: 0,
            theme: "blur",
            addClassNames: !0,
            legend: {position: "right", marginRight: 100, autoMargins: !1},
            innerRadius: "40%",
            defs: {
                filter: [{
                    id: "shadow",
            ...
            dataProvider: [{country: "Lithuania", litres: 501.9}, {
                country: "Czech Republic",
                litres: 301.9
            }, {country: "Ireland", litres: 201.1}, {country: "Germany", litres: 165.8}, {
                country: "Australia",
                litres: 139.9
            }, {country: "Austria", litres: 128.3}, {country: "UK", litres: 99}, {country: "Belgium", litres: 60}],
            valueField: "litres",
            titleField: "country",
            "export": {enabled: !0},
            creditsPosition: "bottom-left",
            ...
            responsive: {
                enabled: !0, rules: [{
                    maxWidth: 900,
                    overrides: {legend: {enabled: !1}}
                }, {
                    maxWidth: 200,
                    overrides: {
                        valueAxes: {labelsEnabled: !1},
                        marginTop: 30,
                        marginBottom: 30,
                        marginLeft: 30,
                        marginRight: 30
        ...
        t.watchDonutChanges(e, n), n.addListener("init", s), n.addListener("rollOverSlice", function (e) {
            l(e)
        })
    }

    angular.module("BlurAdmin.pages.charts.amCharts").controller("PieChartCtrl", e), e.$inject = ["$scope", "$element", "tplSkinChartWatcherHelper", "layoutPaths"]
}(),function () {
    "use strict";
    function e(e, a, t) {
        var i = this;
    ...
    angular.module("BlurAdmin.pages.components.mail").controller("composeBoxCtrl", e), e.$inject = ["subject", "to", "text"]
}(),function () {
    "use strict";
    function e(e) {
    ...
    angular.module("BlurAdmin.pages.components.mail").service("composeModal", e), e.$inject = ["$uibModal"]
}(),function () {
    "use strict";
    function e(e, a) {
        var t = this;
    ...
    angular.module("BlurAdmin.pages.components.mail").controller("MailDetailCtrl", e), e.$inject = ["$stateParams", "mailMessages"]
}(),function () {
    "use strict";
    function e(e, a) {
        var t = this;
    ...
    angular.module("BlurAdmin.pages.components.mail").controller("MailListCtrl", e), e.$inject = ["$stateParams", "mailMessages"]
}(),function () {
    "use strict";
    function e(e, a) {
    ...
    angular.module("BlurAdmin.pages.ui.modals").controller("NotificationsCtrl", e), e.$inject = ["$scope", "toastr"]
}(),!function (e) {
    e.fn.backTop = function (a) {
        var t = this, i = e.extend({
            position: 400,
            speed: 500,
            color: "white"
        }, a), s = i.position, l = i.speed, o = i.color;
    ...
    function e() {
        var e = this;
        e.standardSelectItems = [{label: "Option 1", value: 1}, {label: "Option 2", value: 2}, {
            label: "Option 3",
            value: 3
        }, {label: "Option 4", value: 4}], e.selectWithSearchItems = [{
            label: "Hot Dog, Fries and a Soda",
            value: 1
        }, {label: "Burger, Shake and a Smile", value: 2}, {
            label: "Sugar, Spice and all things nice",
            value: 3
        }, {label: "Baby Back Ribs", value: 4}], e.groupedSelectItems = [{
    ...
    function e() {
        return {
            restrict: "A", require: "?ngOptions", priority: 1500, link: {
                pre: function (e, a, t) {
    ...
    function e(e) {
        return {
            ...
            link: function (a, t, i) {
                e(function () {
                    a.color = i.color, $(t).find("input").bootstrapSwitch({size: "small", onColor: i.color})
                })
            }
        }
    }

    angular.module("BlurAdmin.pages.form").directive("switch", e), e.$inject = ["$timeout"]
}(),function () {
    "use strict";
    function e() {
        return {
            restrict: "A", link: function (e, a, t) {
                $(a).tagsinput({tagClass: "label label-" + t.tagInput})
            }
        }
    }
